...
func TestGet(t *testing.T) {
	documentFileID := uuid.MustParse("111d0cc3-f173-4a78-86c8-5b9de2fbf8d2")
	response := &contracts.DocumentFileResponse{DocumentFileID: documentFileID}
...
func TestGet_NoContent(t *testing.T) {
	...
	var expected *contracts.DocumentFileResponse = nil
	received, err := client.Get("111")
...
func TestSearchByDocumentId(t *testing.T) {
	documentFileID1 := uuid.MustParse("333d0cc3-f173-4a78-86c8-5b9de2fbf8d2")
	documentFileID2 := uuid.MustParse("444d0cc3-f173-4a78-86c8-5b9de2fbf8d2")
	response := []contracts.DocumentFileResponse{
		{DocumentFileID: documentFileID1}, {DocumentFileID: documentFileID2},
	}
	responseBody, _ := json.Marshal(response)
	...
	expected := response
	received, err := client.SearchByDocumentId("111")
...
func TestSearchByDocumentId_ServerError(t *testing.T) {
