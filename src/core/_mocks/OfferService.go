...
// OfferService is an autogenerated mock type for the OfferService type
type OfferService struct {
	mock.Mock
}

// Create provides a mock function with given fields: offer
func (_m *OfferService) Create(offer values.Offer) (*values.Offer, error) {
	ret := _m.Called(offer)
...
func (_m *OfferService) Delete(offerType string) error {
...
func (_m *OfferService) Get(offerType string) (*values.Offer, error) {
	ret := _m.Called(offerType)
...
func (_m *OfferService) List() ([]values.Offer, error) {
	ret := _m.Called()
...
func (_m *OfferService) Update(offer values.Offer) (*values.Offer, error) {
	ret := _m.Called(offer)
